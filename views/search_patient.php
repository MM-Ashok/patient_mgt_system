...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
      <div class="full_container">
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="../public/index.php?page=doctor_dashboard"><img class="img-responsive" src="../public/doctor_dash_style/images/logo/hospital.png" alt="#" /></a>
                        </div>
        ...
        <form action="../public/index.php?page=search_patient" method="POST">
            <Label for ="phone"> Enter Phone </Label>
            <input type ="tel" name ="phone" placeholder="Search Patients"/> 
    ...
    <?php if ($patient): ?>
        ...
        <p>Name: <?= htmlspecialchars($patient['name']) ?></p>
        <p>Phone: <?= htmlspecialchars($patient['phone']) ?></p>
    ...
    <?php else: ?>
        <p>No patient found for this phone number.</p>
    <?php endif; ?>
<?php else: ?>
    <p>Please enter a phone number to search.</p>
<?php endif; ?>
</div>        
