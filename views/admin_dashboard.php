...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-diamond purple_color"></i> <span> Doctors </span></a>
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="../public/index.php?page=add_specialization"> <span>Add Doctor Specialization</span></a></li>
                           <li><a  href="../public/index.php?page=add_doctor"> <span>Add Doctor </span></a></li>
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="../public/admin_style/images/layout_img/admin.jpg" alt="#" /><span class="name_user"><?php echo $_SESSION['admin']['username']; ?></span></a>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="../public/admin_style/images/layout_img/user_img.jpg" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="../public/admin_style/images/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="../public/admin_style/images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                          <span>
      ...
      <script src="../public/admin_style/js/chart_custom_style1.js"></script>
   </body>
</html>