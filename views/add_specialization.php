                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                            ...
                            <div class="container">
                                <h2 class="text-center m-3"> Add Specialization</h2> 
<form action="/patient_mgt_system/public/index.php?page=add_specialization" method="POST" class="container">
    <div class="row mb-3">
        <div class="col-md-6">
    ...
    <button type="submit" class="btn btn-primary m-5">Add Specialization</button>
</form>
</div> 
